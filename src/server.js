...
function sendLandingWithPatches(res) {
  ...
  const paidScript = '<script src="/paid-live-flow.js?v=integrated-report-ui-4"></script>';
  const paidAsyncScript = '<script src="/paid-async-hotfix.js?v=integrated-report-bg-4"></script>';
